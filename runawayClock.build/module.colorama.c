...
static PyCodeObject *codeobj_a0b0e298b2fddea25f2578a66029720a;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[33]); CHECK_OBJECT(module_filename_obj);
    codeobj_a0b0e298b2fddea25f2578a66029720a = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[34], mod_consts[34], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_a0b0e298b2fddea25f2578a66029720a;
    ...
    frame_a0b0e298b2fddea25f2578a66029720a = MAKE_MODULE_FRAME(codeobj_a0b0e298b2fddea25f2578a66029720a, module_colorama);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_a0b0e298b2fddea25f2578a66029720a);
    assert(Py_REFCNT(frame_a0b0e298b2fddea25f2578a66029720a) == 2);
    ...
    // Framed code:
    {
        ...
        frame_a0b0e298b2fddea25f2578a66029720a->m_frame.f_lineno = 1;
        {
    ...
    }
    {
        ...
        frame_a0b0e298b2fddea25f2578a66029720a->m_frame.f_lineno = 2;
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_5)) {
            ...
            tmp_assign_source_10 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_5, mod_consts[21]);
        }
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        frame_a0b0e298b2fddea25f2578a66029720a->m_frame.f_lineno = 3;
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_8)) {
            ...
            tmp_assign_source_14 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_8, mod_consts[26]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_9)) {
            ...
            tmp_assign_source_15 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_9, mod_consts[27]);
        }
    ...
    tmp_import_from_2__module = NULL;
    {
        ...
        frame_a0b0e298b2fddea25f2578a66029720a->m_frame.f_lineno = 4;
        ...
        if (PyModule_Check(tmp_import_name_from_10)) {
            ...
            tmp_assign_source_16 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_10, mod_consts[30]);
        }
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_a0b0e298b2fddea25f2578a66029720a, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_a0b0e298b2fddea25f2578a66029720a->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_a0b0e298b2fddea25f2578a66029720a, exception_lineno);
    }



    assertFrameObject(frame_a0b0e298b2fddea25f2578a66029720a);
