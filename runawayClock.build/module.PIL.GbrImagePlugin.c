...
static void createModuleCodeObjects(void) {
    ...
    codeobj_2e5338495eb358adc5d6f54584f69945 = MAKE_CODE_OBJECT(module_filename_obj, 43, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[59], mod_consts[59], mod_consts[70], NULL, 1, 0, 0);
    codeobj_64abe38dec425b0ab522552ee12d3d5c = MAKE_CODE_OBJECT(module_filename_obj, 90, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[33], mod_consts[33], mod_consts[71], NULL, 1, 0, 0);
}
...
static PyObject *impl_PIL$GbrImagePlugin$$$function__2__open(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_2e5338495eb358adc5d6f54584f69945)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_2e5338495eb358adc5d6f54584f69945 = MAKE_FUNCTION_FRAME(codeobj_2e5338495eb358adc5d6f54584f69945, module_PIL$GbrImagePlugin, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_2e5338495eb358adc5d6f54584f69945);
...
static PyObject *impl_PIL$GbrImagePlugin$$$function__3_load(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_64abe38dec425b0ab522552ee12d3d5c)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_64abe38dec425b0ab522552ee12d3d5c = MAKE_FUNCTION_FRAME(codeobj_64abe38dec425b0ab522552ee12d3d5c, module_PIL$GbrImagePlugin, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_64abe38dec425b0ab522552ee12d3d5c);
