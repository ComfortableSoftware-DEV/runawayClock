...
static PyObject *impl_PIL$WmfImagePlugin$$$function__2_open(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...
#endif
        cache_frame_fb8ab1a822022d65f4ee9c3a053bbdeb = MAKE_FUNCTION_FRAME(codeobj_fb8ab1a822022d65f4ee9c3a053bbdeb, module_PIL$WmfImagePlugin, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
    ...
    // owning it.
    pushFrameStackCompiledFrame(frame_fb8ab1a822022d65f4ee9c3a053bbdeb);
...
static PyObject *impl_PIL$WmfImagePlugin$$$function__3_load(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_fe89b572b501ee7a028e7e58ac0f2487)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_fe89b572b501ee7a028e7e58ac0f2487 = MAKE_FUNCTION_FRAME(codeobj_fe89b572b501ee7a028e7e58ac0f2487, module_PIL$WmfImagePlugin, sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_fe89b572b501ee7a028e7e58ac0f2487);
...
static PyObject *impl_PIL$WmfImagePlugin$$$function__4__accept(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_930990c9d9ca1c342bd24159ebd1a197)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_930990c9d9ca1c342bd24159ebd1a197 = MAKE_FUNCTION_FRAME(codeobj_930990c9d9ca1c342bd24159ebd1a197, module_PIL$WmfImagePlugin, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_930990c9d9ca1c342bd24159ebd1a197);
...
static PyObject *impl_PIL$WmfImagePlugin$$$function__5__open(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_cc14453284df6eaf318d185f9a80b643)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_cc14453284df6eaf318d185f9a80b643 = MAKE_FUNCTION_FRAME(codeobj_cc14453284df6eaf318d185f9a80b643, module_PIL$WmfImagePlugin, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_cc14453284df6eaf318d185f9a80b643);
...
static PyObject *impl_PIL$WmfImagePlugin$$$function__6__load(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_618ad22f1d149a941a39d81b9c8c5a5e)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_618ad22f1d149a941a39d81b9c8c5a5e = MAKE_FUNCTION_FRAME(codeobj_618ad22f1d149a941a39d81b9c8c5a5e, module_PIL$WmfImagePlugin, sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_618ad22f1d149a941a39d81b9c8c5a5e);
...
static PyObject *impl_PIL$WmfImagePlugin$$$function__7_load(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_32cf9994a6d5ae2f2420b6e902993017)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_32cf9994a6d5ae2f2420b6e902993017 = MAKE_FUNCTION_FRAME(codeobj_32cf9994a6d5ae2f2420b6e902993017, module_PIL$WmfImagePlugin, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_32cf9994a6d5ae2f2420b6e902993017);
...
static PyObject *impl_PIL$WmfImagePlugin$$$function__8__save(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_2766c2d0052cb040ad9d595ad3d6fe09)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_2766c2d0052cb040ad9d595ad3d6fe09 = MAKE_FUNCTION_FRAME(codeobj_2766c2d0052cb040ad9d595ad3d6fe09, module_PIL$WmfImagePlugin, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_2766c2d0052cb040ad9d595ad3d6fe09);
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_4)) {
            ...
            tmp_assign_source_8 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_4, mod_consts[75]);
        }
    ...
    branch_end_2:;
    {
        ...
        frame_abb8fdeddf2950de26ea7114db564274_2 = MAKE_CLASS_FRAME(codeobj_abb8fdeddf2950de26ea7114db564274, module_PIL$WmfImagePlugin, NULL, sizeof(void *));

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_abb8fdeddf2950de26ea7114db564274_2);
